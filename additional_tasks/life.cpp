...
{
	fstream f1;
	string path1 = "C:\\Users\\Åâà\\Desktop\\visual studio\\work.out.txt";
...
int main()
{
	...
	vector <int> mass;
	string str;
	string path = "C:\\Users\\Åâà\\Desktop\\visual studio\\work.dat.txt";
	...
	zapis(mass);
	int n;
	cout << "Ââåäèòå êîëè÷åñòâî ïîêîëåíèé: ";
	cin >> n;
