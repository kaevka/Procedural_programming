...
{
	setlocale(0, "russian");
	string path = "C:\\Users\\≈ва\\Desktop\\visual studio\\txt5.5.txt";
	fstream f;
	...
	//а) названи€ игрушек, цена которых не превышает 400 р., и которые подход€т дет€м 8 лет;
	//пункт ј
	cout << "названи€ игрушек, цена которых не превышает 400 р., и которые подход€т дет€м 8 лет" << endl;
	...
	//в) названи€ и цену игрушек, которые подход€т одновременно дет€м 4 - х и 10 - и лет
	//пункт 
	cout << endl;
	cout << "названи€ и цены игрушек, которые подход€т одновременно дет€м 4 - х и 10 - и лет" << endl;
	if (ot1 <= 4 and do1 >= 10)
